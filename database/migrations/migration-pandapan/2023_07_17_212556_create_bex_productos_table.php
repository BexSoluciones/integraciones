...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('bex_productos', function (Blueprint $table) {
            ...
            $table->string('estado_unidademp', 1)->nullable()->default('A');
            $table->string('estado', 1)->nullable()->default('A');
            $table->string('estado_marca', 1)->nullable()->default('A');
            $table->string('estadoproveedor', 1)->nullable()->default('A');
        });
    }
    ...
    {
        Schema::dropIfExists('bex_productos');
    }
};
