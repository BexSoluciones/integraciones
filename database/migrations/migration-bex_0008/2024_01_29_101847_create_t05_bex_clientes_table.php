...
class CreateT05BexClientesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('t05_bex_clientes', function (Blueprint $table) {
            ...
            $table->string('actcliente', 50)->nullable();
            $table->string('idregion', 50)->nullable();
            $table->string('nomregion', 50)->nullable();
            $table->string('idcanal', 20)->nullable();
            $table->string('nomcanal', 50)->nullable();
