    ...
    public function insertCarteraCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                ...
                'type'        => $type,
                'descripcion' => 'Custom::bex_0010/InsertCustom[insertCarteraCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    {   
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[insertClientesCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertDptosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[insertDptosCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertEstadoPedidosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[insertEstadoPedidosCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertEntregasCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[insertEntregasCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
        ...
        try {
            ...
            if($tblbinventario > 10){
                ...
                $tblslicencias = DB::connection($conectionSys)
                    ...
                    ->where('bdlicencias', 'platafor_pi289')
                    ->first();
                ...
                Tbl_Log::create([
                    'id_table'    => $id_importation,
                    'type'  => $type,
                    'descripcion' => 'Custom::bex_0010/InsertCustom[insertInventarioCustom()] => Tabla inventario se encuentra vacia.'
                ]);
                return 1;
            }
            $configDB = $this->connectionDB('bex_0010', 'local'); 
        } catch (\Exception $e) {
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[insertInventarioCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertMpiosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[insertMpiosCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertPaisCustom($conectionBex,  $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[insertPaisCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertPreciosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[insertPreciosCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertProductsCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[insertProductsCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertVendedoresCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type,$modelInstance)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[insertVendedoresCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    {   
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[InsertAmovilCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function InsertDescuentos_ofiCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[insertDescuentos_ofiCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function InsertPromo_Dsctos_TopeCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[InsertPromo_Dsctos_TopeCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    ...
    public function InsertPromo_Dsctos_LineaCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[InsertPromo_Dsctos_LineaCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    ...
    public function InsertBancosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try{
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[InsertBancosCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function InsertCtaBancosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try{
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[InsertCtaBancosCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function InsertBodegasCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try{
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[InsertBodegasCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function InsertClientesCriteriosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try{
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[InsertClientesCriteriosCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function InsertCriteriosProductosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try{
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[InsertCriteriosProductosCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function InsertProductosCriteriosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try{
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0010/InsertCustom[InsertProductosCriteriosCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
