        ...
        try {
            ...
            */
            ...
            Tbl_Log::create([
                ...
                'type'        => $type,
                'descripcion' => 'Custom::bex_0009/InsertCustom[insertCarteraCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    {   
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0009/InsertCustom[insertClientesCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertDptosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0009/InsertCustom[insertDptosCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertEstadoPedidosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0009/InsertCustom[insertEstadoPedidosCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertEntregasCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0009/InsertCustom[insertEntregasCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
        ...
        try {
            ...
            if($tblbinventario > 10){
                ...
                $tblslicencias = DB::connection($conectionSys)
                    ...
                    ->where('bdlicencias', 'platafor_pi061')
                    ->first();
                ...
                Tbl_Log::create([
                    'id_table'    => $id_importation,
                    'type'  => $type,
                    'descripcion' => 'Custom::bex_0009/InsertCustom[insertInventarioCustom()] => Tabla inventario se encuentra vacia.'
                ]);
                return 1;
            }
            $configDB = $this->connectionDB('bex_0009', 'local'); 
        } catch (\Exception $e) {
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0009/InsertCustom[insertInventarioCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertMpiosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0009/InsertCustom[insertMpiosCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertPaisCustom($conectionBex,  $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0009/InsertCustom[insertPaisCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertPreciosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0009/InsertCustom[insertPreciosCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertProductsCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0009/InsertCustom[insertProductsCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertRuteroCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0009/InsertCustom[insertRuteroCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertVendedoresCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0009/InsertCustom[insertVendedoresCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    {   
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0009/InsertCustom[InsertAmovilCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function InsertDescuentos_ofiCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0009/InsertCustom[insertDescuentos_ofiCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
