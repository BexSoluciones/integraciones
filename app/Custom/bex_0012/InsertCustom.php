    ...
    public function insertCarteraCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        ...
        print '◘ Datos insertados en la tabla tblmtipodoc' . PHP_EOL;
            ...
            Tbl_Log::create([
                ...
                'type'        => $type,
                'descripcion' => 'Custom::bex_0012/InsertCustom[insertCarteraCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    {   
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0012/InsertCustom[insertClientesCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertDptosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0012/InsertCustom[insertDptosCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertEstadoPedidosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0012/InsertCustom[insertEstadoPedidosCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
        ...
        try {
            ...
            if($tblbinventario > 10){
                ...
                $tblslicencias = DB::connection($conectionSys)
                    ...
                    ->where('bdlicencias', 'platafor_pi291')
                    ->first();
                ...
                Tbl_Log::create([
                    'id_table'    => $id_importation,
                    'type'  => $type,
                    'descripcion' => 'Custom::bex_0012/InsertCustom[insertInventarioCustom()] => Tabla inventario se encuentra vacia.'
                ]);
                return 1;
            }
            $configDB = $this->connectionDB('bex_0012', 'local'); 
        } catch (\Exception $e) {
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0012/InsertCustom[insertInventarioCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertMpiosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0012/InsertCustom[insertMpiosCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertPaisCustom($conectionBex,  $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0012/InsertCustom[insertPaisCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertPreciosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0012/InsertCustom[insertPreciosCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertProductsCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0012/InsertCustom[insertProductsCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertRuteroCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0012/InsertCustom[insertRuteroCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertVendedoresCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0012/InsertCustom[insertVendedoresCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    {   
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0012/InsertCustom[InsertAmovilCustom()] => '.$e->getMessage()
            ]);
            return 1;
        }
    }
