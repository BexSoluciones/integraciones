    ...
    public function insertCarteraCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            DB::connection($conectionBex)
                    ...
                    function ($query) {
                    $query->select(
                        'tblmrutero.codvendedor','s1e_cartera.codcliente','s1e_cartera.codtipodoc','documento','s1e_cartera.fecmov','fechavenci','valor','debcre')
                    ->from('s1e_cartera')
        ...
        try {
            ...
            if ($inset > 0) {
                ...
                if(count($NuevoVend)>0){
                    foreach($NuevoVend as $vendedor){
                        $dataToInsert[] = [
                            'CODUSUARIO' => $vendedor->tercevendedor,
                            'CODEMPRESA' => '001'
                        ];
                    }
