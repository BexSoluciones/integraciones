        ...
        try {
            ...
            DB::connection($conectionBex)
                ...
                ->insertUsing(
                    ...
                    function ($query) {
                        $query->select(
                            'tblmrutero.codvendedor',
                            's1e_cartera.codcliente',
                            's1e_cartera.codtipodoc',
                            'documento',
                            's1e_cartera.fecmov',
                            'fechavenci',
                            'valor',
            ...
            Tbl_Log::create([
                ...
                'type'        => $type,
                'descripcion' => 'Custom::bex_0011/InsertCustom[insertCarteraCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
        ...
        try {
            ...
            if ($insertClient->isNotEmpty()) {
                ...
                DB::connection($conectionBex)
                    ...
                    ->where('estado', 'A')
                    ->update([
                        's1e_clientes.codcliente' => DB::raw('tblmcliente.codcliente'),
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[insertClientesCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertDptosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[insertDptosCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
        ...
        try {
            ...
            if ($insertCount > 0) {
                ...
                DB::connection($conectionBex)
                    ...
                    ->insertUsing([
                        'numpedido', 'feccrepedido', 'fecpromesa', 'dircliente', 'vendedor',
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[insertEstadoPedidosCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertEntregasCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[insertEntregasCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
        ...
        try {
            ...
            if ($tblbinventario > 10) {
                ...
                $tblslicencias = DB::connection($conectionSys)
                    ...
                    ->where('bdlicencias', 'platafor_pi288')
                    ->first();
                ...
                Tbl_Log::create([
                    'id_table'    => $id_importation,
                    'type'  => $type,
                    'descripcion' => 'Custom::bex_0011/InsertCustom[insertInventarioCustom()] => Tabla inventario se encuentra vacia.'
                ]);
                return 1;
            }
            $configDB = $this->connectionDB('bex_0011', 'local');
        } catch (\Exception $e) {
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[insertInventarioCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertMpiosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[insertMpiosCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertPaisCustom($conectionBex,  $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[insertPaisCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertPreciosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[insertPreciosCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
        ...
        try {
            ...
            DB::connection($conectionBex)
                ...
                ->update([
                    ...
                    'tblmproducto.PLUPRODUCTO' => DB::raw('s1e_productos.plu'),
                    'tblmproducto.codunidademp' => DB::raw('s1e_productos.codunidademp'),
                    'tblmproducto.CODPROVEEDOR' => DB::raw('s1e_productos.codproveedor'),
                    'tblmproducto.CODBARRA' => DB::raw('s1e_productos.codbarra'),
                    'tblmproducto.CODMARCA' => DB::raw('s1e_productos.codmarca')
                ]);
            ...
            if (count($insertProduc) > 0) {
                DB::connection($conectionBex)
                    ...
                    ->insertUsing(
                        ...
                        function ($query) {
                            $query->selectRaw('codigo,"001" as codempresa,plu,descripcion,s1e_productos.codunidademp,
                        "0" as bonentregaproducto,"0" as codgrupoproducto,s1e_productos.estado,"1" as unidadventa')
                                ->distinct()
                                ->from('s1e_productos')
                                ->where('estado', 'A')
                                ->where('codigo', '<>', '')
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[insertProductsCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertRuteroCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[insertRuteroCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function insertVendedoresCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type, $modelInstance)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[insertVendedoresCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function InsertAmovilCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[InsertAmovilCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
        ...
        try {
            ...
            if ($insertCount > 0) {
                ...
                $cantie = DB::connection($conectionBex)
                    ...
                    ->insertUsing([
                        'idcia', 'rowid', 'descripcion', 'estado', 'estado1', 'fini', 'ffin', 'co', 'codproducto', 'porcdcto', 'tipoinv',
                ...
                DB::connection($conectionBex)
                    ...
                    ->insertUsing([
                        'idcia', 'rowid', 'estado', 'estado1', 'fini', 'ffin', 'co', 'codproducto', 'porcdcto', 'tipoinv', 'grupodctoitem',
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[insertDescuentos_ofiCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function InsertPromo_Dsctos_TopeCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[InsertPromo_Dsctos_TopeCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function InsertBancosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[InsertBancosCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function InsertCtaBancosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[InsertCtaBancosCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function InsertBodegasCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[InsertBodegasCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function InsertClientesCriteriosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[InsertClientesCriteriosCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function InsertCriteriosProductosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[InsertCriteriosProductosCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
    ...
    public function InsertProductosCriteriosCustom($conectionBex, $conectionSys, $datosAInsertar, $id_importation, $type)
    {
        try {
            ...
            Tbl_Log::create([
                'id_table'    => $id_importation,
                'type'        => $type,
                'descripcion' => 'Custom::Custom::bex_0011/InsertCustom[InsertProductosCriteriosCustom()] => ' . $e->getMessage()
            ]);
            return 1;
        }
    }
