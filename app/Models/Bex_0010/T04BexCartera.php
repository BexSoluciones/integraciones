...
protected $fillable = ['cia','codvendedor','nitcliente', 'succliente', 'codtipodoc', 'documento', 'fecmov', 'fechavenci', 'valor', 'debcre', 'recpro', 'co_docto', 'codcliente', 'vrpostf', 'diasmora', 'co_odc', 'tipdoc_odc', 'docto_odc', 'planilla', 'aux_cruce', 'co_cruce', 'un_cruce', 'tipdoc_cruce', 'numdoc_cruce', 'estadotipodoc'];
